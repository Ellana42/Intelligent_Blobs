...
settings = {
    ...
    'food_omega': 2 * pi / 800,  # Vitesse de rotation en radian/tick
    ...
    'food_strength': 300,  # Valeur à distance nulle
    ...
    'blob_initial_energy': 300,
    'blob_speed': 10,  # Distance parcourue par tick
    'blob_omega': 0.5, # Vitesse angulaire en radians / tick
    'energy_per_move': 2,  # Perte d'energie par déplacement
    'energy_per_rotate': 0.6, # Perte d'énergie par rotation
